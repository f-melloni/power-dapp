...
using PowerDapp_UserArea.Models.AccountViewModels;
...
namespace PowerDapp_UserArea.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private string hostName { get {
                return _env.IsDevelopment() ? _configuration["Hostnames:Dev"] : _configuration["Hostnames:Prod"];
            }
        }
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult RegistrationComplete(string id = null)
        {
            ViewData["userId"] = id;
            return View();
        }
        ...
        public async Task<IActionResult> ResendConfirmationEmail(string userId)
        {
            if (!string.IsNullOrEmpty(userId)) {
                ...
                var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.Id, code }, protocol: HttpContext.Request.Scheme, host: hostName );
                ...
                return RedirectToAction("RegistrationComplete", new { id = user.Id });
            }
            else {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid) {
                ...
                var callbackUrl = Url.Action("ResetPassword", "Account", new { userId = user.Id, code }, protocol: HttpContext.Request.Scheme, host: hostName);
